...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <a href="index.php">Home<span> Cart</span></a>
        </div>
    </div>
    <div class="line"></div>
    <!-- Cart -->
    <section class="shop">
        ...
        ?>
           ...
           <div class="box-container">
            ...
            <div class="box">
                <div class="icon">
                    <a href="view_page.php?=<?php echo $fetch_cart['id']; ?>" class="bi bi-eye-fill"></a>
        ...
        <div class="dlt">
            <a href="cart.php?delete_all" name="delete_all" class="btn2" onclick="return confirm('do you want to delete all items in your wishlist?')">Delete All</a>
        </div>
        <div class="wishlist_total">
            <p>total amount payable: <span>R<?php echo $grand_total; ?></span></p>
            <a href="shop.php" class="btn">continue shopping</a>
            <a href="checkout.php" name="delete_all" class="btn <?php echo ($grand_total>1)?'':'disabled'?>">Proceed To Checkout</a>
        </div>
    </section>
    <div class="line"></div>
