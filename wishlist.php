...
<body>
    ...
    <div class="banner">
        <div class="detail">
            ...
            <a href="index.php">Home<span> Wishlist</span></a>
        </div>
    </div>
    <div class="line"></div>
    <!-- Wishlist -->
    <section class="shop">
        ...
        ?>
           ...
           <div class="box-container">
            ...
            <form method="post" class="box">
                ...
                <div class="icon">
                    <a href="view_page.php?=<?php echo $fetch_wishlist['id']; ?>" class="bi bi-eye-fill"></a>
        ...
        <div class="wishlist_total">
            ...
            <a href="wishlist.php?delete_all" name="delete_all" class="btn <?php echo ($grand_total)?'':'disabled'?>" onclick="return confirm('do you want to delete all items in your wishlist?')">Delete All</a>
        </div>
    </section>
    <div class="line"></div>
