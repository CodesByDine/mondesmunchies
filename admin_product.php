...
<body>
    ...
    <section class="add-products form-container">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="input-field">
                ...
                <textarea name="detail" accept="image/jpg, image/jpeg, image/png, image/webp" required></textarea>
            </div>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            ?>
            <div class="box">
                <img src="image/<?php echo $fetch_products['image']; ?>" width='250' height='250'>
                <p>price : R <?php echo $fetch_products['price']; ?></p>
                ...
                <a href="admin_product.php?delete=<?php echo $fetch_products['id']; ?>" class="delete" onclick="return confirm('Do you want to delete this product?');">delete</a>
            </div>
            <?php 
                    }
            }else{
